		...
		<div class="mx-auto max-w-5xl px-6">
			...
			>
				...
				<div class="absolute inset-0 m-auto flex size-fit justify-center gap-2">
					<IntegrationCardv7
						class="shadow-black-950/10 size-16 bg-white/25 shadow-xl backdrop-blur-sm  backdrop-grayscale dark:border-white/10 dark:shadow-white/15"
						isCenter={true}
					>
						<svg
			...
			<div class="mx-auto mt-12 max-w-lg space-y-6 text-center">
