	...
	<section class="relative">
		<div class="relative py-24 lg:py-28">
			<div class="mx-auto max-w-7xl px-6 md:px-12">
				...
				<div class="x-auto relative mx-auto mt-8 max-w-lg sm:mt-12">
					<div
					...
					></div>
					<div
						class="absolute inset-x-0 top-12 -z-[1] mx-auto h-1/3 w-2/3 rounded-full bg-blue-300 blur-3xl dark:bg-white/20"
					></div>
...
{#snippet workosLogo()}
	...
	>
		<g>
			<path
				fill="currentColor"
				class="text-[#29363D] dark:text-white"
...
{#snippet astroLogo()}
	<svg class="mx-auto h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460 160" fill="none">
		<path
...
{#snippet netlifyLogo()}
	...
	>
		...
		<defs>
			<clip-path id="clip0_235_8">
				<rect width="512" height="208.126" fill="white" />
			</clip-path>
		</defs>
	</svg>
	<svg
		class="mx-auto hidden h-12 dark:block"
		xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 512 209"
		fill="none"
	>
