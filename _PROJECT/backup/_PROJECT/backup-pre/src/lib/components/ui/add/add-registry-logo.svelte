<script lang="ts">
	import GithubLogo from "$lib/components/assets/logos/github.svelte";
	import JsrepoLogo from "$lib/components/assets/logos/jsrepo.svelte";
	import GitlabLogo from "$lib/components/assets/logos/gitlab.svelte";
	import BitbucketLogo from "$lib/components/assets/logos/bitbucket.svelte";
	import type { Component } from "svelte";
	import AzureDevops from "$lib/components/assets/logos/azure-devops.svelte";
