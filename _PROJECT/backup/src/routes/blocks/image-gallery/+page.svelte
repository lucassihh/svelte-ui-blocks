...
<svelte:head>
	<title>Image Gallery Blocks | Svelte Efferd Blocks</title>
	<meta
		name="description"
		content="Preview curated image gallery block variants with a tree-style source explorer in Svelte Efferd Blocks."
	/>
</svelte:head>
