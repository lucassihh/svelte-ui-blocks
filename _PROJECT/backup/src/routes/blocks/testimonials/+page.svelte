...
<svelte:head>
	<title>Testimonials Blocks | Svelte Efferd Blocks</title>
	<meta
		name="description"
		content="Preview curated testimonial block variants with a tree-style source explorer in Svelte Efferd Blocks."
	/>
</svelte:head>
