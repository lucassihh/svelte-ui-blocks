...
<svelte:head>
	<title>Feature Blocks | Svelte Efferd Blocks</title>
	<meta
		name="description"
		content="Preview curated feature block variants with a tree-style source explorer in Svelte Efferd Blocks."
	/>
</svelte:head>
