...
<svelte:head>
	<title>Pricing Blocks | Svelte Efferd Blocks</title>
	<meta
		name="description"
		content="Preview curated pricing block variants with a tree-style source explorer in Svelte Efferd Blocks."
	/>
</svelte:head>
