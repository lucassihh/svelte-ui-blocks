...
<svelte:head>
	<title>Integration Blocks | Svelte Efferd Blocks</title>
	<meta
		name="description"
		content="Preview curated integration block variants with a tree-style source explorer in Svelte Efferd Blocks."
	/>
</svelte:head>
