...
<Seo
	title="Text Rotate Blocks"
	desc="Preview curated text-rotate block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/text-rotate"
/>
