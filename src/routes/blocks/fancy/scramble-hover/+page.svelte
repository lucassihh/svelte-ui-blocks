...
<Seo
	title="Scramble Hover Blocks"
	desc="Preview curated scramble-hover block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/scramble-hover"
/>
