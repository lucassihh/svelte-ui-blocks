...
<Seo
	title="Media Between Text Blocks"
	desc="Preview curated media-between-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/media-between-text"
/>
