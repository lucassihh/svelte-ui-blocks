...
<Seo
	title="Scramble In Blocks"
	desc="Preview curated scramble-in block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/scramble-in"
/>
