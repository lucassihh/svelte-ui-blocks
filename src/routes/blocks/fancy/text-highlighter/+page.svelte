...
<Seo
	title="Text Highlighter Blocks"
	desc="Preview curated text-highlighter block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/text-highlighter"
/>
