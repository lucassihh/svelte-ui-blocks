...
<Seo
	title="Animated Gradient Svg Blocks"
	desc="Preview curated animated-gradient-svg block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/animated-gradient-svg"
/>
