...
<Seo
	title="Letter Swap Good Blocks"
	desc="Preview curated letter-swap-good block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/letter-swap-good"
/>
