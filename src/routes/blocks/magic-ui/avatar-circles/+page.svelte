...
<Seo
	title="Avatar Circles Blocks"
	desc="Preview curated avatar-circles block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/avatar-circles"
/>
