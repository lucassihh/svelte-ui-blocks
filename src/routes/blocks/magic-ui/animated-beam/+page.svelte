...
<Seo
	title="Animated Beam Blocks"
	desc="Preview curated animated-beam block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/animated-beam"
/>
