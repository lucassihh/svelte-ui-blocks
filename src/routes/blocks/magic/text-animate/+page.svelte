...
<Seo
	title="Text Animate Blocks"
	desc="Preview curated text-animate block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/text-animate"
/>
