...
<Seo
	title="Flickering Grid Blocks"
	desc="Preview curated flickering-grid block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/flickering-grid"
/>
