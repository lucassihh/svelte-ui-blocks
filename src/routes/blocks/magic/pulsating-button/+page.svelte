...
<Seo
	title="Pulsating Button Blocks"
	desc="Preview curated pulsating-button block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/pulsating-button"
/>
