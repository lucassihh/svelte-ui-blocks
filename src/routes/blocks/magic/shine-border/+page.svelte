...
<Seo
	title="Shine Border Blocks"
	desc="Preview curated shine-border block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/shine-border"
/>
