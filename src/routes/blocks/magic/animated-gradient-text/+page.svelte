...
<Seo
	title="Animated Gradient Text Blocks"
	desc="Preview curated animated-gradient-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/animated-gradient-text"
/>
