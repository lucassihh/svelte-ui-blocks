...
<Seo
	title="Pixel Image Blocks"
	desc="Preview curated pixel-image block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/pixel-image"
/>
