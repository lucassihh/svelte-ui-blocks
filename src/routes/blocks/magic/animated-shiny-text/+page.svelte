...
<Seo
	title="Animated Shiny Text Blocks"
	desc="Preview curated animated-shiny-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/animated-shiny-text"
/>
