...
<Seo
	title="Shimmer Button Blocks"
	desc="Preview curated shimmer-button block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/shimmer-button"
/>
