...
<Seo
	title="Progressive Blur Blocks"
	desc="Preview curated progressive-blur block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/progressive-blur"
/>
