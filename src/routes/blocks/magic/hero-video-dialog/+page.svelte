...
<Seo
	title="Hero Video Dialog Blocks"
	desc="Preview curated hero-video-dialog block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/hero-video-dialog"
/>
