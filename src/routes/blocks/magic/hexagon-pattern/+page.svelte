...
<Seo
	title="Hexagon Pattern Blocks"
	desc="Preview curated hexagon-pattern block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/hexagon-pattern"
/>
