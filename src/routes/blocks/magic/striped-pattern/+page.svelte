...
<Seo
	title="Striped Pattern Blocks"
	desc="Preview curated striped-pattern block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/striped-pattern"
/>
