...
<Seo
	title="Morphing Text Blocks"
	desc="Preview curated morphing-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/morphing-text"
/>
