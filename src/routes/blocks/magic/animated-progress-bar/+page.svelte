...
<Seo
	title="Animated Progress Bar Blocks"
	desc="Preview curated animated-progress-bar block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/animated-progress-bar"
/>
