...
<Seo
	title="Dot Pattern Blocks"
	desc="Preview curated dot-pattern block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/dot-pattern"
/>
