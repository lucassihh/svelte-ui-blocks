...
<Seo
	title="Border Beam Blocks"
	desc="Preview curated border-beam block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/border-beam"
/>
