...
<Seo
	title="Stagger Text Blocks"
	desc="Preview curated stagger-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/stagger-text"
/>
