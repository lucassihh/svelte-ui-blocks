...
<Seo
	title="Animated List Blocks"
	desc="Preview curated animated-list block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/animated-list"
/>
