...
<Seo
	title="Typing Animation Blocks"
	desc="Preview curated typing-animation block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/typing-animation"
/>
