...
<Seo
	title="Noise Texture Blocks"
	desc="Preview curated noise-texture block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/noise-texture"
/>
