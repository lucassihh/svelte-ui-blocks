...
<Seo
	title="Glyph Matrix Blocks"
	desc="Preview curated glyph-matrix block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/glyph-matrix"
/>
