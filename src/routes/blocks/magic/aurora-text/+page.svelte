...
<Seo
	title="Aurora Text Blocks"
	desc="Preview curated aurora-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/aurora-text"
/>
