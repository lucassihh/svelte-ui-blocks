...
<Seo
	title="Number Ticker Blocks"
	desc="Preview curated number-ticker block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/number-ticker"
/>
