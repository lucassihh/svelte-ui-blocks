...
<Seo
	title="Sparkles Text Blocks"
	desc="Preview curated sparkles-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/sparkles-text"
/>
