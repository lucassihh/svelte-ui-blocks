...
<Seo
	title="Line Shadow Text Blocks"
	desc="Preview curated line-shadow-text block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/line-shadow-text"
/>
