...
<Seo
	title="Word Rotate Blocks"
	desc="Preview curated word-rotate block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/word-rotate"
/>
