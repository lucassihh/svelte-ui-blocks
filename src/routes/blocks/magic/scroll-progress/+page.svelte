...
<Seo
	title="Scroll Progress Blocks"
	desc="Preview curated scroll-progress block variants with a tree-style source explorer in Svelte Efferd Blocks."
	link="/blocks/scroll-progress"
/>
