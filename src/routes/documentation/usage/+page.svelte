...
>
	...
	<Paragraph>
		Stay close to the block pages. They are where previews, source context, and install actions come
		together, which makes it easier to choose the right starting point before you pull code into
		your project.
	</Paragraph>
	...
	<Steps class="mt-8">
		...
		<Step>
			...
			<Paragraph>
				Use the previews to judge spacing, content density, and layout structure. Pick the option
				that needs the least rewriting for your product.
			</Paragraph>
		</Step>
		...
		<Step>
			...
			<Paragraph>
				The install control on each block carries the block-specific registry URL, which is more
				reliable than using a generic command from memory.
			</Paragraph>
		</Step>
		...
		<Step>
			...
			<Paragraph>
				Treat the generated code as a strong starting point. Replace placeholder content, align
				colors and spacing with your product, and remove anything the page does not need.
			</Paragraph>
		</Step>
	</Steps>
	...
	<UnorderedList>
		<ListItem>Make sure the chosen layout actually fits your real content and hierarchy.</ListItem>
		<ListItem>
			Review generated styles and dependencies so they sit cleanly inside your existing codebase.
		</ListItem>
		<ListItem>
			Keep an eye on the <Link href="/changelog">changelog</Link> if you want to revisit blocks as the
			library improves.
		</ListItem>
	</UnorderedList>
