...
import PricingFourPreview from "$lib/components/blocks/efferd/pricing/pricing-four/frequency-toggle.svelte";
import PricingOnePreview from "$lib/components/blocks/efferd/pricing/pricing-one/pricing.svelte";
import PricingThreePreview from "$lib/components/blocks/efferd/pricing/pricing-three/pricing-card.svelte";
import PricingTwoPreview from "$lib/components/blocks/efferd/pricing/pricing-two/pricing.svelte";
...
import pricingPricingFourFrequencyToggleSource from "$lib/components/blocks/efferd/pricing/pricing-four/frequency-toggle.svelte?raw";
import pricingPricingFourPricingSource from "$lib/components/blocks/efferd/pricing/pricing-four/pricing.svelte?raw";
import pricingPricingOnePricingSource from "$lib/components/blocks/efferd/pricing/pricing-one/pricing.svelte?raw";
import pricingPricingThreePricingCardSource from "$lib/components/blocks/efferd/pricing/pricing-three/pricing-card.svelte?raw";
import pricingPricingTwoPricingSource from "$lib/components/blocks/efferd/pricing/pricing-two/pricing.svelte?raw";
...
export const pricingBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("pricing-one", [
			{
				id: "pricing-one",
				path: "src/lib/components/blocks/efferd/pricing/pricing-one/pricing.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("pricing-two", [
			{
				id: "pricing-two",
				path: "src/lib/components/blocks/efferd/pricing/pricing-two/pricing.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("pricing-three", [
			{
				id: "pricing-three",
				path: "src/lib/components/blocks/efferd/pricing/pricing-three/pricing-card.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("pricing-four:pricing", [
			{
				...
				path: "src/lib/components/blocks/efferd/pricing/pricing-four/frequency-toggle.svelte",
				lang: "svelte",
				code: pricingPricingFourFrequencyToggleSource
			},
			{
				id: "pricing-four:pricing",
				path: "src/lib/components/blocks/efferd/pricing/pricing-four/pricing.svelte",
				lang: "svelte",
