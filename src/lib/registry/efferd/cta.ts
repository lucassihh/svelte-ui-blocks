...
import CtaFivePreview from "$lib/components/blocks/efferd/cta/cta-five/cta.svelte";
import CtaFourPreview from "$lib/components/blocks/efferd/cta/cta-four/cta.svelte";
import CtaOnePreview from "$lib/components/blocks/efferd/cta/cta-one/cta.svelte";
import CtaThreePreview from "$lib/components/blocks/efferd/cta/cta-three/cta.svelte";
import CtaTwoPreview from "$lib/components/blocks/efferd/cta/cta-two/cta.svelte";

// Raw
import ctaCtaFiveCtaSource from "$lib/components/blocks/efferd/cta/cta-five/cta.svelte?raw";
import ctaCtaFourCtaSource from "$lib/components/blocks/efferd/cta/cta-four/cta.svelte?raw";
import ctaCtaOneCtaSource from "$lib/components/blocks/efferd/cta/cta-one/cta.svelte?raw";
import ctaCtaThreeCtaSource from "$lib/components/blocks/efferd/cta/cta-three/cta.svelte?raw";
import ctaCtaTwoCtaSource from "$lib/components/blocks/efferd/cta/cta-two/cta.svelte?raw";
...
export const ctaBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("cta-one", [
			{
				id: "cta-one",
				path: "src/lib/components/blocks/efferd/cta/cta-one/cta.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("cta-two", [
			{
				id: "cta-two",
				path: "src/lib/components/blocks/efferd/cta/cta-two/cta.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("cta-three", [
			{
				id: "cta-three",
				path: "src/lib/components/blocks/efferd/cta/cta-three/cta.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("cta-four", [
			{
				id: "cta-four",
				path: "src/lib/components/blocks/efferd/cta/cta-four/cta.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("cta-five", [
			{
				id: "cta-five",
				path: "src/lib/components/blocks/efferd/cta/cta-five/cta.svelte",
				lang: "svelte",
