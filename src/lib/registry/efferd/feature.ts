...
import FeatureFivePreview from "$lib/components/blocks/efferd/feature/feature-five/feature-card.svelte";
import FeatureFourPreview from "$lib/components/blocks/efferd/feature/feature-four/feature-card.svelte";
import FeatureOnePreview from "$lib/components/blocks/efferd/feature/feature-one/feature.svelte";
import FeatureThreePreview from "$lib/components/blocks/efferd/feature/feature-three/feature.svelte";
import FeatureTwoPreview from "$lib/components/blocks/efferd/feature/feature-two/feature.svelte";
...
import featureFeatureFiveFeatureCardSource from "$lib/components/blocks/efferd/feature/feature-five/feature-card.svelte?raw";
import featureFeatureFourFeatureCardSource from "$lib/components/blocks/efferd/feature/feature-four/feature-card.svelte?raw";
import featureFeatureOneFeatureSource from "$lib/components/blocks/efferd/feature/feature-one/feature.svelte?raw";
import featureFeatureThreeFeatureSource from "$lib/components/blocks/efferd/feature/feature-three/feature.svelte?raw";
import featureFeatureTwoFeatureSource from "$lib/components/blocks/efferd/feature/feature-two/feature.svelte?raw";
...
export const featureBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("feature-one", [
			{
				id: "feature-one",
				path: "src/lib/components/blocks/efferd/feature/feature-one/feature.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("feature-two", [
			{
				id: "feature-two",
				path: "src/lib/components/blocks/efferd/feature/feature-two/feature.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("feature-three", [
			{
				id: "feature-three",
				path: "src/lib/components/blocks/efferd/feature/feature-three/feature.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("feature-four", [
			{
				id: "feature-four",
				path: "src/lib/components/blocks/efferd/feature/feature-four/feature-card.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("feature-five", [
			{
				id: "feature-five",
				path: "src/lib/components/blocks/efferd/feature/feature-five/feature-card.svelte",
				lang: "svelte",
