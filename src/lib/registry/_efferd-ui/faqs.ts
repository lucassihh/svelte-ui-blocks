...
import FaqFive from "$lib/components/efferd-ui/faqs/faq-five.svelte";
import FaqFour from "$lib/components/efferd-ui/faqs/faq-four.svelte";
import FaqOne from "$lib/components/efferd-ui/faqs/faq-one.svelte";
import FaqThree from "$lib/components/efferd-ui/faqs/faq-three.svelte";
import FaqTwo from "$lib/components/efferd-ui/faqs/faq-two.svelte";

import faqFiveSource from "$lib/components/efferd-ui/faqs/faq-five.svelte?raw";
import faqFourSource from "$lib/components/efferd-ui/faqs/faq-four.svelte?raw";
import faqOneSource from "$lib/components/efferd-ui/faqs/faq-one.svelte?raw";
import faqThreeSource from "$lib/components/efferd-ui/faqs/faq-three.svelte?raw";
import faqTwoSource from "$lib/components/efferd-ui/faqs/faq-two.svelte?raw";
...
export const faqBlocks: BlockShowcaseItem[] = [
	{
		...
		previewHref: "/preview/efferd-ui/faqs/one",
		previewMode: "inline",
		previewHeight: 520,
		installId: "faq-one",
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/faqs/two",
		previewMode: "iframe",
		previewHeight: 900,
		installId: "faq-two",
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/faqs/three",
		previewMode: "iframe",
		previewHeight: 900,
		installId: "faq-three",
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/faqs/four",
		previewMode: "iframe",
		previewHeight: 900,
		installId: "faq-four",
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/faqs/five",
		previewMode: "iframe",
		previewHeight: 980,
		installId: "faq-five",
