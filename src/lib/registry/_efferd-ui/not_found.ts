...
import NotFoundTwo from "$lib/components/efferd-ui/not-found/not-found-two.svelte";

import notFoundOneSource from "$lib/components/efferd-ui/not-found/not-found-one.svelte?raw";
import notFoundTwoSource from "$lib/components/efferd-ui/not-found/not-found-two.svelte?raw";
...
export const notFoundBlocks: BlockShowcaseItem[] = [
	{
		...
		previewHref: "/preview/efferd-ui/not-found/one",
		previewMode: "iframe",
		previewHeight: 720,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/not-found/two",
		previewMode: "iframe",
		previewHeight: 720,
