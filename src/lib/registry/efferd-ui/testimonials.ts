...
import TestimonialFive from "$lib/components/efferd-ui/testimonial/testimonial-five/testimonial-five.svelte";
import TestimonialFour from "$lib/components/efferd-ui/testimonial/testimonial-four/testimonial-four.svelte";

import testimonialCardSource from "$lib/components/efferd-ui/testimonial/testimonial-card.svelte?raw";
import testimonialOneSource from "$lib/components/efferd-ui/testimonial/testimonial-one.svelte?raw";
import testimonialThreeSource from "$lib/components/efferd-ui/testimonial/testimonial-three.svelte?raw";
import testimonialTwoSource from "$lib/components/efferd-ui/testimonial/testimonial-two.svelte?raw";
import testimonialFiveCardSource from "$lib/components/efferd-ui/testimonial/testimonial-five/testimonial-card.svelte?raw";
import testimonialFiveSource from "$lib/components/efferd-ui/testimonial/testimonial-five/testimonial-five.svelte?raw";
import testimonialFourCardSource from "$lib/components/efferd-ui/testimonial/testimonial-four/testimonial-card.svelte?raw";
import testimonialFourSource from "$lib/components/efferd-ui/testimonial/testimonial-four/testimonial-four.svelte?raw";
