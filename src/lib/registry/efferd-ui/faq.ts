...
import FaqFivePreview from "$lib/components/blocks/efferd-ui/faq/faq-five/faq.svelte";
import FaqFourPreview from "$lib/components/blocks/efferd-ui/faq/faq-four/faq.svelte";
import FaqOnePreview from "$lib/components/blocks/efferd-ui/faq/faq-one/faq.svelte";
import FaqThreePreview from "$lib/components/blocks/efferd-ui/faq/faq-three/faq.svelte";
import FaqTwoPreview from "$lib/components/blocks/efferd-ui/faq/faq-two/faq.svelte";
...
import faqFaqFiveFaqSource from "$lib/components/blocks/efferd-ui/faq/faq-five/faq.svelte?raw";
import faqFaqFourFaqSource from "$lib/components/blocks/efferd-ui/faq/faq-four/faq.svelte?raw";
import faqFaqOneFaqSource from "$lib/components/blocks/efferd-ui/faq/faq-one/faq.svelte?raw";
import faqFaqThreeFaqSource from "$lib/components/blocks/efferd-ui/faq/faq-three/faq.svelte?raw";
import faqFaqTwoFaqSource from "$lib/components/blocks/efferd-ui/faq/faq-two/faq.svelte?raw";
...
export const faqBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("faq-two", [
			{
				id: "faq-two",
				path: "src/lib/components/blocks/efferd-ui/faq/faq-two/faq.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("faq-three", [
			{
				id: "faq-three",
				path: "src/lib/components/blocks/efferd-ui/faq/faq-three/faq.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("faq-four", [
			{
				id: "faq-four",
				path: "src/lib/components/blocks/efferd-ui/faq/faq-four/faq.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("faq-five", [
			{
				id: "faq-five",
				path: "src/lib/components/blocks/efferd-ui/faq/faq-five/faq.svelte",
				lang: "svelte",
