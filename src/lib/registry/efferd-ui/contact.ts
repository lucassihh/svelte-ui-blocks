...
import ContactFivePreview from "$lib/components/blocks/efferd-ui/contact/contact-five/contact.svelte";
import ContactFourPreview from "$lib/components/blocks/efferd-ui/contact/contact-four/contact.svelte";
import ContactOnePreview from "$lib/components/blocks/efferd-ui/contact/contact-one/contact.svelte";
import ContactThreePreview from "$lib/components/blocks/efferd-ui/contact/contact-three/contact.svelte";
import ContactTwoPreview from "$lib/components/blocks/efferd-ui/contact/contact-two/contact.svelte";

// Raw
import contactContactFiveContactFormSource from "$lib/components/blocks/efferd-ui/contact/contact-five/contact-form.svelte?raw";
import contactContactFiveContactSource from "$lib/components/blocks/efferd-ui/contact/contact-five/contact.svelte?raw";
import contactContactFourContactSource from "$lib/components/blocks/efferd-ui/contact/contact-four/contact.svelte?raw";
import contactContactOneContactSource from "$lib/components/blocks/efferd-ui/contact/contact-one/contact.svelte?raw";
import contactContactThreeContactSource from "$lib/components/blocks/efferd-ui/contact/contact-three/contact.svelte?raw";
import contactContactTwoContactSource from "$lib/components/blocks/efferd-ui/contact/contact-two/contact.svelte?raw";
...
export const contactBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("contact-one", [
			{
				id: "contact-one",
				path: "src/lib/components/blocks/efferd-ui/contact/contact-one/contact.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("contact-two", [
			{
				id: "contact-two",
				path: "src/lib/components/blocks/efferd-ui/contact/contact-two/contact.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("contact-three", [
			{
				id: "contact-three",
				path: "src/lib/components/blocks/efferd-ui/contact/contact-three/contact.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("contact-four", [
			{
				id: "contact-four",
				path: "src/lib/components/blocks/efferd-ui/contact/contact-four/contact.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("contact-five:contact", [
			{
				...
				path: "src/lib/components/blocks/efferd-ui/contact/contact-five/contact-form.svelte",
				lang: "svelte",
				code: contactContactFiveContactFormSource
			},
			{
				id: "contact-five:contact",
				path: "src/lib/components/blocks/efferd-ui/contact/contact-five/contact.svelte",
				lang: "svelte",
