...
import marqueeIndexSource from "$lib/components/ui-blocks/magic-ui/marquee/index.ts?raw";
import marqueeSource from "$lib/components/ui-blocks/magic-ui/marquee/marquee.svelte?raw";
