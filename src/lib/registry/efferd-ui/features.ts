...
import FeatureTwo from "$lib/components/efferd-ui/features/feature-two.svelte";

import featureFiveCardSource from "$lib/components/efferd-ui/features/feature-five/feature-card.svelte?raw";
import featureFiveSource from "$lib/components/efferd-ui/features/feature-five/feature-five.svelte?raw";
import featureFourCardSource from "$lib/components/efferd-ui/features/feature-four/feature-card.svelte?raw";
import featureFourSource from "$lib/components/efferd-ui/features/feature-four/feature-four.svelte?raw";
import featureOneSource from "$lib/components/efferd-ui/features/feature-one.svelte?raw";
import featureThreeSource from "$lib/components/efferd-ui/features/feature-three.svelte?raw";
import featureTwoSource from "$lib/components/efferd-ui/features/feature-two.svelte?raw";
...
export const featuresBlocks: BlockShowcaseItem[] = [
	{
		...
		previewHref: "/preview/efferd-ui/features/one",
		previewMode: "inline",
		previewHeight: 260,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/features/two",
		previewMode: "inline",
		previewHeight: 420,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/features/three",
		previewMode: "iframe",
		previewHeight: 900,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/features/four",
		previewMode: "iframe",
		previewHeight: 900,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/features/five",
		previewMode: "inline",
		previewHeight: 520,
