...
import IntegrationFivePreview from "$lib/components/efferd-ui/integration/integration-five/integration.svelte";
import IntegrationFourPreview from "$lib/components/efferd-ui/integration/integration-four/integration-card-four.svelte";
import IntegrationOnePreview from "$lib/components/efferd-ui/integration/integration-one/integration.svelte";
import IntegrationThreePreview from "$lib/components/efferd-ui/integration/integration-three/integration-card-three.svelte";
import IntegrationTwoPreview from "$lib/components/efferd-ui/integration/integration-two/integration-card-two.svelte";
...
import integrationIntegrationFiveIntegrationSource from "$lib/components/efferd-ui/integration/integration-five/integration.svelte?raw";
import integrationIntegrationFourIntegrationCardFourSource from "$lib/components/efferd-ui/integration/integration-four/integration-card-four.svelte?raw";
import integrationIntegrationFourIntegrationSource from "$lib/components/efferd-ui/integration/integration-four/integration.svelte?raw";
import integrationIntegrationOneIntegrationSource from "$lib/components/efferd-ui/integration/integration-one/integration.svelte?raw";
import integrationIntegrationThreeIntegrationCardThreeSource from "$lib/components/efferd-ui/integration/integration-three/integration-card-three.svelte?raw";
import integrationIntegrationThreeIntegrationSource from "$lib/components/efferd-ui/integration/integration-three/integration.svelte?raw";
import integrationIntegrationTwoIntegrationCardTwoSource from "$lib/components/efferd-ui/integration/integration-two/integration-card-two.svelte?raw";
import integrationIntegrationTwoIntegrationSource from "$lib/components/efferd-ui/integration/integration-two/integration.svelte?raw";
...
export const integrationBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("integration-one:preview", [
			{
				id: "integration-one:integration",
				path: "components/efferd/integration/integration-one/integration.svelte",
				lang: "svelte",
		...
		codeTree: createBlockCodeTree("integration-three:preview", [
			{
				id: "integration-three:integration-card-three",
				path: "components/efferd/integration/integration-three/integration-card-three.svelte",
				lang: "svelte",
				code: integrationIntegrationThreeIntegrationCardThreeSource
			},
			{
				id: "integration-three:integration",
				path: "components/efferd/integration/integration-three/integration.svelte",
				lang: "svelte",
