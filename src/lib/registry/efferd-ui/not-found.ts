...
import NotFoundOnePreview from "$lib/components/efferd-ui/not-found/not-found-one/not-found.svelte";
import NotFoundTwoPreview from "$lib/components/efferd-ui/not-found/not-found-two/not-found.svelte";
...
import notFoundNotFoundOneNotFoundSource from "$lib/components/efferd-ui/not-found/not-found-one/not-found.svelte?raw";
import notFoundNotFoundTwoNotFoundSource from "$lib/components/efferd-ui/not-found/not-found-two/not-found.svelte?raw";
...
export const notFoundBlocks: BlockShowcaseItem[] = [
	{
		...
		codeTree: createBlockCodeTree("not-found-one:preview", [
			{
				id: "not-found-one:not-found",
				path: "components/efferd/not-found/not-found-one/not-found.svelte",
				lang: "svelte",
	...
	},
	{
		...
		codeTree: createBlockCodeTree("not-found-two:preview", [
			{
				id: "not-found-two:not-found",
				path: "components/efferd/not-found/not-found-two/not-found.svelte",
				lang: "svelte",
