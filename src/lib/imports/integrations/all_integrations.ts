...
import IntegrationThree from "$lib/components/efferd-ui/integrations/integration-three.svelte";
import IntegrationTwo from "$lib/components/efferd-ui/integrations/integration-two.svelte";

import integrationCardFourSource from "$lib/components/efferd-ui/integrations/integration-card-four.svelte?raw";
import integrationCardThreeSource from "$lib/components/efferd-ui/integrations/integration-card-three.svelte?raw";
import integrationCardTwoSource from "$lib/components/efferd-ui/integrations/integration-card-two.svelte?raw";
import integrationFiveSource from "$lib/components/efferd-ui/integrations/integration-five.svelte?raw";
import integrationFourSource from "$lib/components/efferd-ui/integrations/integration-four.svelte?raw";
import integrationOneSource from "$lib/components/efferd-ui/integrations/integration-one.svelte?raw";
import integrationThreeSource from "$lib/components/efferd-ui/integrations/integration-three.svelte?raw";
import integrationTwoSource from "$lib/components/efferd-ui/integrations/integration-two.svelte?raw";
...
export const integrationBlocks: BlockShowcaseItem[] = [
	{
		...
		previewHref: "/preview/efferd-ui/integrations/one",
		previewMode: "inline",
		previewHeight: 360,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/integrations/two",
		previewMode: "inline",
		previewHeight: 520,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/integrations/three",
		previewMode: "inline",
		previewHeight: 560,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/integrations/four",
		previewMode: "inline",
		previewHeight: 560,
	...
	},
	{
		...
		previewHref: "/preview/efferd-ui/integrations/five",
		previewMode: "inline",
		previewHeight: 520,
