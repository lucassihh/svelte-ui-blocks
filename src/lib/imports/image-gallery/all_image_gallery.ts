...
import imageGallerySource from "$lib/components/efferd-ui/image-gallery/image-gallery.svelte?raw";
import lazyImageSource from "$lib/components/efferd-ui/image-gallery/lazy-image.svelte?raw";
