...
<Sidebar.Root bind:ref {showCloseButton} side={sidebarPosition} {...restProps} class="w-full md:w-[16rem] md:pt-8 md:ml-2 border-2 border-yellow-400">
    <Sidebar.Content>
		<Sidebar.Group>
...
{:else}
<!-- Documentation - Sidebar Desktop (Withou Shadcn) -->
