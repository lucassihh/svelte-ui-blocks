...
<section class="relative -top-14 mx-auto w-full max-w-5xl px-4">
	...
	<div class="relative flex flex-col items-center justify-center gap-5 pt-46 pb-10">
		...
		<a
			class="group animate-in fill-mode-backwards slide-in-from-bottom-10 fade-in mx-auto flex w-fit items-center gap-3 rounded-full border bg-card px-3 py-1 shadow transition-all delay-500 duration-500 ease-out"
			href="/"
		>
