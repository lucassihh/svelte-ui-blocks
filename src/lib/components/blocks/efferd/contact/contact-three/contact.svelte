...
<div class="relative mx-auto min-h-screen max-w-5xl overflow-x-clip border-x border-border">
	...
	<div class="grid md:grid-cols-3">
		{#each contactItems as item, index}
			...
			>
				<div
					class={cn(
						"flex items-center gap-x-3 border-b border-border bg-secondary/50 p-4 dark:bg-secondary/20",
	...
	<div class="z-1 flex h-full flex-col items-center justify-center gap-4 py-24">
		...
		<div class="flex flex-wrap items-center gap-2">
			{#each socialLinks as link}
				...
				<a
					class="flex items-center gap-x-2 rounded-full border border-border bg-card px-3 py-1.5 shadow hover:bg-accent"
					href={link.href}
