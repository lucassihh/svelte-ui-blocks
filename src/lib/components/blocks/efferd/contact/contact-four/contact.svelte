...
<div
	class="relative mx-auto grid h-full w-full max-w-4xl rounded-2xl border border-border md:grid-cols-[1fr_0.70fr]"
>
		...
		<div class="grid gap-4">
			{#each contactInfo as info}
				...
				<div class={cn("flex items-center gap-3 py-3")}>
					<div class="rounded-lg border border-border bg-card p-3 shadow-xs [&_svg]:size-5">
						<Icon />
					</div>
					<div>
