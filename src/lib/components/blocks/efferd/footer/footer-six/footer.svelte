...
<footer
	class="relative h-(--footer-height) w-full border-t [--footer-height:520px] border-border"
	...
	<div class="fixed bottom-0 h-(--footer-height) w-full">
		<div class="sticky top-[calc(100vh-var(--footer-height))] h-full overflow-y-auto">
			...
			<div class="relative mx-auto flex size-full max-w-6xl flex-col justify-between gap-5">
				...
				<div
					class="flex flex-col items-center justify-between gap-2 border-t p-4 text-sm text-muted-foreground md:flex-row border-border"
				>
