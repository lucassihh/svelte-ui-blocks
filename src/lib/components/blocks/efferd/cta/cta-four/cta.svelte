...
<div
	class="relative mx-auto flex w-full max-w-3xl flex-col justify-between gap-y-6 rounded-4xl border border-border bg-card px-4 py-8 shadow-sm md:py-10 dark:bg-card/50"
>
	<div class="space-y-2">
