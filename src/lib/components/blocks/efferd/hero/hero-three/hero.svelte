...
<section class="mx-auto w-full max-w-5xl overflow-hidden pt-16">
	...
	<div class="relative z-10 flex max-w-2xl flex-col gap-5 px-4">
		<a
			class="group animate-in fill-mode-backwards slide-in-from-bottom-10 fade-in flex w-fit items-center gap-3 rounded-sm border border-border bg-card p-1 shadow-xs transition-all delay-500 duration-500 ease-out"
			href="/"
		>
	...
	<div class="relative">
		...
		>
			<div
				class="relative mx-auto max-w-5xl overflow-hidden rounded-lg border border-border bg-background p-2 shadow-xl ring-1 inset-shadow-2xs ring-card inset-shadow-foreground/10 dark:inset-shadow-xs dark:inset-shadow-foreground/20"
			>
				<img
					alt="app screen"
					class="z-2 aspect-video rounded-lg border border-border dark:hidden"
					height="1080"
