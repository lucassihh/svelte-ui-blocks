...
<section class="relative -top-14 mx-auto w-full max-w-5xl px-4">
	...
	<div class="relative flex flex-col items-center justify-center gap-5 pt-46 pb-10">
		...
		<a
			class="group animate-in fill-mode-backwards slide-in-from-bottom-10 fade-in mx-auto flex w-fit items-center gap-3 rounded-full border border-border bg-card px-3 py-1 shadow transition-all delay-500 duration-500 ease-out"
			href="/"
		>
			<Rocket class="size-3 text-muted-foreground" />
			<span class="text-xs">shipped new features!</span>
			<span class="block h-5 border-l border-border"></span>
			<ArrowRight class="size-3 duration-150 ease-out group-hover:translate-x-1" />
		</a>

		<h1
			class="animate-in fill-mode-backwards slide-in-from-bottom-10 fade-in text-center text-4xl tracking-tight text-balance delay-100 duration-500 ease-out [text-shadow:0_0_50px_color-mix(in_oklab,var(--foreground)_20%,transparent)] md:text-5xl lg:text-6xl"
		>
			Building Teams Help
			<br />
			You Scale and Lead
		...
		<p
			class="animate-in fill-mode-backwards slide-in-from-bottom-10 fade-in mx-auto max-w-md text-center text-base tracking-wider text-foreground/80 delay-200 duration-500 ease-out sm:text-lg md:text-xl"
		>
		...
		<div
			class="animate-in fill-mode-backwards slide-in-from-bottom-10 fade-in flex flex-row flex-wrap items-center justify-center gap-3 pt-2 delay-300 duration-500 ease-out"
		>
