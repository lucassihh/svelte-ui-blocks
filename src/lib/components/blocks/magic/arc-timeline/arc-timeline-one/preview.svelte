<script lang="ts">
	...
	import { ArcTimeline, type ArcTimelineItem } from "$lib/components/ui/magic-ui/arc-timeline";
...
<div class="bg-card w-full max-w-6xl rounded-[2rem] border border-border px-4 py-10 shadow-sm sm:px-8">
	<ArcTimeline
