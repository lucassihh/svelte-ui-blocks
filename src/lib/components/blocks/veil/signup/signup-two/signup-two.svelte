...
<section data-theme="veil" class="flex min-h-screen bg-background px-4 py-16 md:py-24">
	<div class="m-auto w-full max-w-sm rounded-2xl border border-border bg-muted p-8">
		<div>
			<Button
				href="/"
				aria-label="go home"
			...
			>
				<Logo class="h-6 w-fit" />
			</Button>
			<h1 class="mt-6 font-serif text-2xl font-medium">Sign up</h1>
			<p class="mt-1 text-sm text-muted-foreground">Create your account to continue</p>
		</div>
		...
		<div class="space-y-2">
			<Button type="button" variant="outline" class="w-full">
				<svg xmlns="http://www.w3.org/2000/svg" class="size-4" viewBox="0 0 256 262">
					<path
						fill="#4285f4"
