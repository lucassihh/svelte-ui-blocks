...
<section data-theme="veil" class="flex grid min-h-screen grid-rows-[auto_1fr] bg-background px-4">
	<div class="mx-auto w-full max-w-7xl border-b border-border py-3">
		<Button
			href="/"
			aria-label="go home"
			variant="ghost"
