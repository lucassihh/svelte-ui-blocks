...
<section data-theme="veil" class="@container bg-background py-24">
	<div class="mx-auto max-w-2xl px-6">
		<Card variant="outline" class="grid gap-8 p-6 md:p-8 @xl:grid-cols-2">
			...
			<div class="flex flex-col justify-center rounded-xl border border-border bg-muted/50 p-6">
