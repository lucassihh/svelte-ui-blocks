	...
	<div class="mx-auto max-w-2xl px-6">
		...
		<Card variant="outline" class="mt-12 overflow-auto @max-md:*:min-w-md">
			<div class="grid grid-cols-3">
				<div class="p-4"></div>
				<div class="min-w-32 border-l border-border p-4 text-center">
					<p class="font-medium text-foreground">Free</p>
					<p class="font-serif text-2xl font-medium">$0</p>
				</div>
				<div class="min-w-32 border-l border-border bg-primary/5 p-4 text-center">
			...
			{#each features as feature (feature.name)}
				<div class="grid grid-cols-3 border-t border-border">
					...
					<div class="flex min-w-32 items-center justify-center border-l border-border p-4 text-sm">
					...
					<div
						class="flex min-w-32 items-center justify-center border-l border-border bg-primary/5 p-4 text-sm"
					>
			...
			<div class="grid grid-cols-3 border-t border-border">
				<div class="p-4"></div>
				<div class="min-w-32 border-l border-border p-4">
					<Button href="#link" variant="outline" size="sm" class="w-full">Get Started</Button>
				</div>
				<div class="min-w-32 border-l border-border bg-primary/5 p-4">
